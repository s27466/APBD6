...
public interface IWarehouseRepository
{
    ...
    public Task RegisterProductInWarehouseByProcedureAsync(int idWarehouse, int idProduct, int idOrder, DateTime createdAt);
}
...
public class WarehouseRepository : IWarehouseRepository
{
    ...
    public async Task RegisterProductInWarehouseByProcedureAsync(int idWarehouse, int idProduct, int idOrder, DateTime createdAt)
    {
        await using var connection = new SqlConnection(_configuration["ConnectionStrings:DefaultConnection"]);
        await connection.OpenAsync();
